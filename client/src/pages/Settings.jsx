    ...
    return (
        <div className="p-10 font-body bg-bg-void min-h-screen text-text-primary relative overflow-hidden">
            ...
            <header className="flex flex-col lg:flex-row justify-between items-start lg:items-end gap-6 mb-12 z-10 relative">
                ...
                <div className="flex flex-col sm:flex-row gap-4 sm:items-center sm:justify-end w-full lg:w-auto">
                    ...
                    <button 
                        onClick={handleSave}
                        disabled={isSaving}
                        className="bg-leaf-400 text-bg-void px-8 py-3.5 rounded-2xl font-black text-sm uppercase tracking-widest shadow-glow hover:scale-105 active:scale-95 transition-all flex items-center justify-center gap-2 whitespace-nowrap"
                    >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 z-10 relative">
                ...
                {/* Profile Card */}
                <div className="lg:col-span-7 bg-bg-elevated/40 glass p-10 rounded-[40px] border border-leaf-900/20 shadow-2xl">
                    ...
                    <div className="space-y-8">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                            <div className="space-y-3">
                                ...
                                <div className="relative group">
                                    ...
                                    <input 
                                        type="text" 
                                        className="w-full bg-bg-void/50 border border-leaf-900/30 rounded-2xl py-4 pl-12 pr-4 text-sm focus:border-leaf-400/50 outline-none transition-all"
                        ...
                        <div className="p-6 rounded-3xl bg-bg-void/30 border border-leaf-900/20 flex justify-between items-center group hover:border-leaf-400/20 transition-all">
                            <div className="flex items-center gap-4">
                                <div className="w-12 h-12 rounded-2xl bg-bg-elevated border border-leaf-900/20 flex items-center justify-center text-leaf-400">
                                    <Shield size={22} />
                                </div>
                                <div>
                ...
                <div className="lg:col-span-5 flex flex-col gap-8">
                    <div className="bg-bg-elevated/40 glass p-8 rounded-[40px] border border-leaf-900/20 shadow-xl">
                        ...
                        <div className="space-y-4">
                            {[
                                ...
                                <div key={i} className="flex justify-between items-center p-4 rounded-2xl bg-bg-void/30 border border-leaf-900/10">
                                    <span className="text-xs font-bold text-text-secondary">{item.label}</span>
                                    <div className={`w-10 h-5 rounded-full relative cursor-pointer transition-colors ${item.val ? 'bg-leaf-400' : 'bg-bg-elevated border border-leaf-900/30'}`}>
                                        <div className={`absolute top-1 w-3 h-3 rounded-full transition-all ${item.val ? 'right-1 bg-bg-void' : 'left-1 bg-leaf-900/50'}`}></div>
                                    </div>
                                </div>
                            ))}
                        </div>
                    ...
                    <div className="bg-bg-elevated/40 glass p-8 rounded-[40px] border border-leaf-900/20 shadow-xl flex-1">
                        <h3 className="text-xl font-display font-bold mb-6 flex items-center gap-3">
                            <Globe size={20} className="text-leaf-400" /> Sistema
                        </h3>
                        <div className="space-y-4">
                            <div className="p-4 rounded-2xl bg-bg-void/30 border border-leaf-900/10 flex justify-between items-center">
                                ...
                                <select className="bg-transparent text-xs font-black text-leaf-400 outline-none cursor-pointer uppercase tracking-tighter">
                                    <option className="bg-bg-void">Español</option>
                                    <option className="bg-bg-void">English</option>
                                </select>
                            </div>
